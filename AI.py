...
class AI:
    ...
    def analyze_stats(self, stats: dict[str, Any]) -> str:
        ...
        instruction = """
Ты — наставник в World of Tanks. Говори живым русским языком, на «ты», ёмко. У тебя 2 минуты — дай самое важное.
...
**ТВОЙ ОТВЕТ — сплошной текст из нескольких абзацев. Без заголовков.**
